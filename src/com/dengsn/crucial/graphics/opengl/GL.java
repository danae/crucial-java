package com.dengsn.crucial.graphics.opengl;
...
{    
  ...
  {
    GL.pie(rect.center(),Math.min(rect.width(),rect.height()) / 2.0,startAngle,endAngle);
  }
  ...
  public static void rectangle(Rect rect)
  {
    glBegin(GL_QUADS);
      ...
      glVertex2d(rect.tl.x,rect.br.y);
      glVertex2d(rect.br.x,rect.br.y);
      glVertex2d(rect.br.x,rect.tl.y);
    glEnd();  
  }
  ...
  {
    GL.line(new Point(rect.tl.x,rect.tl.y),new Point(rect.tl.x,rect.br.y));
    GL.line(new Point(rect.tl.x,rect.tl.y),new Point(rect.br.x,rect.tl.y));
    GL.line(new Point(rect.br.x,rect.tl.y),new Point(rect.br.x,rect.br.y));
    GL.line(new Point(rect.tl.x,rect.br.y),new Point(rect.br.x,rect.br.y));
  }
  ...
  {
    return (
      (r2.tl.x >= r1.tl.x && r2.tl.x <= r1.br.x)
      || (r2.br.x >= r1.tl.x && r2.br.x <= r1.br.x)
      || (r2.tl.y >= r1.tl.y && r2.tl.y <= r1.br.y)
      || (r2.br.y >= r1.tl.y && r2.br.y <= r1.br.y)
    );  
  }
}
